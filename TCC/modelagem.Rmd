...
Não consegui calcular AIC para esses modelos. Tem algo de estranho as variáveis do grupo 2. Reduzi a amostra pra pegar só o que não for NA para cada variável do grupo 2. As variáveis S114(SUS) e I00102(plano) continuaram dando problema mesmo com o ajuste.
